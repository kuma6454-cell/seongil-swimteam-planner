...
const METRO_POOLS = {
  ...
  "대구광역시": ["대구시민수영장","달서구민체육센터 수영장"],
  "인천광역시": ["인천문학박태환 수영장","중구민체육센터 수영장"],
  "광주광역시": ["광주남부대 시립국제수영장","광산구민체육센터 수영장"],
  "대전광역시": ["대전시민수영장","대덕구민체육센터 수영장"],
  "울산광역시": ["울산시민수영장","울주군민체육센터 수영장"],
  "세종특별자치시": ["세종시민체육관 수영장","도담동 수영장"],
};
const PROVINCE_POOLS = {
  "경기도": {"수원시":["수원시민체육관 수영장","수원실내수영장"],"성남시":["성남시민체육관 수영장","분당구 수영장"],"고양시":["고양시민체육관 수영장","덕양구 수영장"],"용인시":["용인시민체육관 수영장","기흥구 수영장"],"부천시":["부천시민체육관 수영장","원미구 수영장"],"안산시":["안산시민체육관 수영장","단원구 수영장"],"안양시":["안양시민체육관 수영장","만안구 수영장"],"남양주시":["남양주시민체육관 수영장","별내면 수영장"],"화성시":["화성시민체육관 수영장","동탄 수영장"],"평택시":["평택시민체육관 수영장"],"의정부시":["의정부시민체육관 수영장"],"시흥시":["시흥시민체육관 수영장","정왕동 수영장"],"파주시":["파주시민체육관 수영장"],"김포시":["김포시민체육관 수영장"],"광주시":["광주시민체육관 수영장"],"광명시":["광명시민체육관 수영장"],"군포시":["군포시민체육관 수영장"],"하남시":["하남시민체육관 수영장"],"오산시":["오산시민체육관 수영장"],"이천시":["이천시민체육관 수영장"],"양주시":["양주시민체육관 수영장"],"구리시":["구리시민체육관 수영장"],"포천시":["포천시민체육관 수영장"],"의왕시":["의왕시민체육관 수영장"],"여주시":["여주시민체육관 수영장"],"동두천시":["동두천시민체육관 수영장"],"양평군":["양평군민체육관 수영장"],"가평군":["가평군민체육관 수영장"],"연천군":["연천군민체육관 수영장"]},
  "강원특별자치도": {"춘천시":["춘천 국민체육센터 수영장"],"원주시":["원주시민체육관 수영장"],"강릉시":["강릉시민체육관 수영장"],"동해시":["동해시민체육관 수영장"],"태백시":["태백시민체육관 수영장"],"속초시":["속초시민체육관 수영장"],"삼척시":["삼척시민체육관 수영장"],"홍천군":["홍천군민체육관 수영장"],"횡성군":["횡성군민체육관 수영장"],"영월군":["영월군민체육관 수영장"],"평창군":["평창군민체육관 수영장"],"정선군":["정선군민체육관 수영장"],"철원군":["철원군민체육관 수영장"],"화천군":["화천군민체육관 수영장"],"양구군":["양구군민체육관 수영장"],"인제군":["인제군민체육관 수영장"],"고성군":["고성군민체육관 수영장"],"양양군":["양양군민체육관 수영장"]},
  ...
  "전라남도": {"목포시":["목포시민체육관 수영장","옥암동 수영장"],"여수시":["여수시민체육관 수영장","돌산도 수영장"],"순천시":["순천시민체육관 수영장","조례동 수영장"],"나주시":["나주시민체육관 수영장"],"광양시":["광양 수영장"],"담양군":["담양군민체육관 수영장"],"곡성군":["곡성군민체육관 수영장"],"구례군":["구례군민체육관 수영장"],"고흥군":["고흥군민체육관 수영장"],"보성군":["보성군민체육관 수영장"],"화순군":["화순군민체육관 수영장"],"장흥군":["장흥군민체육관 수영장"],"강진군":["강진군민체육관 수영장"],"해남군":["해남군민체육관 수영장"],"영암군":["영암군민체육관 수영장"],"무안군":["무안군민체육관 수영장"],"함평군":["함평군민체육관 수영장"],"영광군":["영광군민체육관 수영장"],"장성군":["장성군민체육관 수영장"],"완도군":["완도군민체육관 수영장"],"진도군":["진도군민체육관 수영장"],"신안군":["신안군민체육관 수영장"]},
  "경상북도": {"포항시":["포항시민체육관 수영장","남구 수영장","북구 수영장"],"경주시":["경주시민체육관 수영장","황성동 수영장"],"김천시":["김천 실내수영장"],"안동시":["안동시민체육관 수영장","옥동 수영장"],"구미시":["구미시민체육관 수영장","원평동 수영장"],"영주시":["영주시민체육관 수영장"],"영천시":["영천시민체육관 수영장"],"상주시":["상주시민체육관 수영장"],"문경시":["문경시민체육관 수영장"],"경산시":["경산시민체육관 수영장"],"군위군":["군위군민체육관 수영장"],"의성군":["의성군민체육관 수영장"],"청송군":["청송군민체육관 수영장"],"영양군":["영양군민체육관 수영장"],"영덕군":["영덕군민체육관 수영장"],"청도군":["청도군민체육관 수영장"],"고령군":["고령군민체육관 수영장"],"성주군":["성주군민체육관 수영장"],"칠곡군":["칠곡군민체육관 수영장"],"예천군":["예천군민체육관 수영장"],"봉화군":["봉화군민체육관 수영장"],"울진군":["울진군민체육관 수영장"],"울릉군":["울릉군민체육관 수영장"]},
  "경상남도": {"창원시":["창원 실내수영장","의창구 수영장","성산구 수영장","마산합포구 수영장","마산회원구 수영장","진해구 수영장"],"진주시":["진주시민체육관 수영장","상대동 수영장"],"통영시":["통영시민체육관 수영장"],"사천시":["사천시민체육관 수영장"],"김해시":["김해시민체육관 수영장","내외동 수영장"],"밀양시":["밀양시민체육관 수영장"],"거제시":["거제시민체육관 수영장","고현동 수영장"],"양산시":["양산시민체육관 수영장","물금읍 수영장"],"의령군":["의령군민체육관 수영장"],"함안군":["함안군민체육관 수영장"],"창녕군":["창녕군민체육관 수영장"],"고성군":["고성군민체육관 수영장"],"남해군":["남해군민체육관 수영장"],"하동군":["하동군민체육관 수영장"],"산청군":["산청군민체육관 수영장"],"함양군":["함양군민체육관 수영장"],"거창군":["거창군민체육관 수영장"],"합천군":["합천군민체육관 수영장"]},
  "제주특별자치도": {"제주시":["제주 실내수영장","노형동 수영장","아라동 수영장","한림읍 수영장","애월읍 수영장"],"서귀포시":["서귀포시민체육관 수영장","대정읍 수영장","남원읍 수영장","성산읍 수영장"]},
};
...
export default function App() {
  ...
  const saveEvent = async () => {
    ...
    try {
      ...
      setModal(null);
      // 카카오 공유 (저장 후 자동 팝업)
      showToast(isEdit?"✏️ 일정이 수정됐어요!":"🏊 일정이 추가됐어요!","success");

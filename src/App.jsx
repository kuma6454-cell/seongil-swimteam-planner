...
// ─── 수영장 데이터 ─────────────────────────────────────────────────────────────
const DEFAULT_POOL = "서울체육고등학교수영장 (송파구 방이동)";
const METRO_POOLS = {
  "서울특별시": ["서울체육고등학교 수영장","잠실 실내수영장","한국체육대학교 수영장","성일스포렉스","온조대왕체육센터 수영장","올림픽 수영장"],
  "부산광역시": ["부산사직 실내수영장","해운대수영장","기장군수영장","북구민체육센터 수영장","사상구민체육센터 수영장","동래구민체육센터 수영장","연제구민체육센터 수영장","수영구민체육센터 수영장","남구민체육센터 수영장","부산진구민체육센터 수영장"],
  "대구광역시": ["대구시민수영장","달서구민체육센터 수영장","북구민체육센터 수영장","수성구민체육센터 수영장","동구민체육센터 수영장","서구민체육센터 수영장"],
  "인천광역시": ["문학박태환 수영장","남동구민체육센터 수영장","부평구민체육센터 수영장","계양구민체육센터 수영장","서구민체육센터 수영장","미추홀구민체육센터 수영장","연수구민체육센터 수영장","중구민체육센터 수영장"],
  "광주광역시": ["남부대시립국제 수영장","북구민체육센터 수영장","서구민체육센터 수영장","남구민체육센터 수영장","동구민체육센터 수영장","광산구민체육센터 수영장"],
...
const S = {
  ...
  cell:       { minHeight:66, background:"white", borderRadius:10, padding:"5px 4px 4px", cursor:"pointer", border:"1px solid #CCEEFF", overflow:"hidden" },
  cellEmpty:  { background:"transparent", border:"none", cursor:"default" },

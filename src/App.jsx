...
const METRO_POOLS = {
  "서울특별시": ["서울체육고등학교수영장","잠실실내수영장","한국체육대학교수영장","성일스포렉스","온조대왕체육센터수영장","올림픽수영장"],
  "부산광역시": ["부산사직실내수영장","해운대수영장","기장군수영장","북구민체육센터 수영장","사상구민체육센터 수영장","동래구민체육센터 수영장","연제구민체육센터 수영장","수영구민체육센터 수영장","남구민체육센터 수영장","부산진구민체육센터 수영장"],
  ...
  "광주광역시": ["남부대시립국제수영장","북구민체육센터 수영장","서구민체육센터 수영장","남구민체육센터 수영장","동구민체육센터 수영장","광산구민체육센터 수영장"],
...
const PROVINCE_POOLS = {
  ...
  "경상북도": {"포항시":["포항시민체육관 수영장","남구 수영장","북구 수영장"],"경주시":["경주시민체육관 수영장","황성동 수영장"],"김천시":["김천실내수영장"],"안동시":["안동시민체육관 수영장","옥동 수영장"],"구미시":["구미시민체육관 수영장","원평동 수영장"],"영주시":["영주시민체육관 수영장"],"영천시":["영천시민체육관 수영장"],"상주시":["상주시민체육관 수영장"],"문경시":["문경시민체육관 수영장"],"경산시":["경산시민체육관 수영장"],"군위군":["군위군민체육관 수영장"],"의성군":["의성군민체육관 수영장"],"청송군":["청송군민체육관 수영장"],"영양군":["영양군민체육관 수영장"],"영덕군":["영덕군민체육관 수영장"],"청도군":["청도군민체육관 수영장"],"고령군":["고령군민체육관 수영장"],"성주군":["성주군민체육관 수영장"],"칠곡군":["칠곡군민체육관 수영장"],"예천군":["예천군민체육관 수영장"],"봉화군":["봉화군민체육관 수영장"],"울진군":["울진군민체육관 수영장"],"울릉군":["울릉군민체육관 수영장"]},
  "경상남도": {"창원시":["창원실내수영장","의창구 수영장","성산구 수영장","마산합포구 수영장","마산회원구 수영장","진해구 수영장"],"진주시":["진주시민체육관 수영장","상대동 수영장"],"통영시":["통영시민체육관 수영장"],"사천시":["사천시민체육관 수영장"],"김해시":["김해시민체육관 수영장","내외동 수영장"],"밀양시":["밀양시민체육관 수영장"],"거제시":["거제시민체육관 수영장","고현동 수영장"],"양산시":["양산시민체육관 수영장","물금읍 수영장"],"의령군":["의령군민체육관 수영장"],"함안군":["함안군민체육관 수영장"],"창녕군":["창녕군민체육관 수영장"],"고성군":["고성군민체육관 수영장"],"남해군":["남해군민체육관 수영장"],"하동군":["하동군민체육관 수영장"],"산청군":["산청군민체육관 수영장"],"함양군":["함양군민체육관 수영장"],"거창군":["거창군민체육관 수영장"],"합천군":["합천군민체육관 수영장"]},
  "제주특별자치도": {"제주시":["제주실내수영장","노형동 수영장","아라동 수영장","한림읍 수영장","애월읍 수영장"],"서귀포시":["서귀포시민체육관 수영장","대정읍 수영장","남원읍 수영장","성산읍 수영장"]},
};
